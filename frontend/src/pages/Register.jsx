            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
                <div className="bg-white text-black px-6 md:px-10 py-10 md:py-12 rounded-md w-full max-w-[400px] shadow-lg">
                    ...
                    <form onSubmit={handleRegister} className="flex flex-col gap-3">
                        ...
                        <button type="submit" className="bg-[#f6121d] text-white py-2 rounded font-bold mt-2 text-sm cursor-pointer">
                            Đăng ký
                        </button>
                    </form>
                    ...
                    <div className="mt-6 text-sm text-gray-700 text-center">
                        Đã có tài khoản?{" "}
                        <Link to="/login" className="text-[#e50914] underline cursor-pointer">
                            Đăng nhập.
                        </Link>
                    </div>
                </div>
