                ...
                <div className="bg-white text-black px-6 md:px-10 py-10 md:py-12 rounded-md w-full max-w-[400px] shadow-lg">
                    ...
                    <form onSubmit={handleLogin} className="flex flex-col gap-4">
                        ...
                        <input
                            ...
                            required
                        />
                        <button type="submit" className="bg-[#f6121d] text-white cursor-pointer py-3 rounded font-bold mt-2">
                            Đăng nhập
                        </button>
                    </form>
                    ...
                    <div className="mt-6 text-sm text-gray-700">
                        ...
                        <Link to="/register" className="text-[#f6121d] underline cursor-pointer">
                            Đăng ký.
                        </Link>
                    </div>
                </div>
